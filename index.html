if(document.getElementById('datatable')){
            ...
            function fetch() {
                ...
                xhr.open("GET", `${fileName}?query= + ${encodeURI(makeQuery())}`, true);
            ...
            function makeQuery() {
                ...
                query = `SELECT * from ${db_table} where 1 ${searchQuery} ORDER BY ${orderBy} ${order} limit ${rowsPerPage} ${limit};`;
                return query;
            }
